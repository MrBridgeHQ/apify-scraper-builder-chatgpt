# apify-scraper-builder — ChatGPT / Codex Agent Skill

An Agent Skill **for ChatGPT (OpenAI Codex)**. **Target LLM: ChatGPT / Codex.**

**→ The skill lives in [`skills/apify-scraper-builder/`](skills/apify-scraper-builder/).** Copy that folder into your `~/.codex/skills/` directory.
