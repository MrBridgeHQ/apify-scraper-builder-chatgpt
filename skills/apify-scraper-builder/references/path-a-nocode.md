...
Default to **cheerio-scraper** until you observe that selectors return nothing (then escalate to web-scraper), per the tool-ladder doctrine in your scraping reference layer.
...
- Standby mode (the no-code Actors aren't Standby)
